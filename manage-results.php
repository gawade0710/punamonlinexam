...
<?php include('includes/leftbar.php');?>  
                    ...
                    <div class="main-page">
                        <div class="container-fluid" style="margin-top:-700px;">
                            <div >
                                <div >
                                    <h2 class="title" style="padding-left:330px;"></h2>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel" style="margin-left:250px;">
...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>Well done!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
										<center>
                                            <div class="panel-body p-20" style="background:lightblue;">

                                                <table id="example" class="display table table-striped table-bordered:red" cellspacing="0" width="100%">
                                                    <thead >
                                                        <tr >
                                                            <th>#</th>
                                                            <th>Student Name</th>
